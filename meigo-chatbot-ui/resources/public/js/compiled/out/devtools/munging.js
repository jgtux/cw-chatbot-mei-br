...
var o22323 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22323["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22324 = temp__5718__auto____$1;
return (o22324["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21495__auto__ = f;
return (o__21495__auto__["toString"]).call(o__21495__auto__);
} else {
return "";
}
}catch (e22325){var _ = e22325;
return "";
}});
...
try{var o__21495__auto___22327 = t;
(o__21495__auto___22327["cljs$lang$ctorPrWriter"]).call(o__21495__auto___22327,t,writer);
}catch (e22326){var __22328 = e22326;
}
...
var char_code = (function (){var o__21495__auto__ = (new String(char$));
return (o__21495__auto__["charCodeAt"]).call(o__21495__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21495__auto__ = String;
return (o__21495__auto__["fromCharCode"]).call(o__21495__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22329 = num_code;
switch (G__22329) {
case (1):
return (185);
...
var o__21495__auto__ = String;
return (o__21495__auto__["fromCharCode"]).call(o__21495__auto__,superscript_code);
});
/**
...
}catch (e22331){var _e__21502__auto__ = e22331;
return false;
}})())){
...
var vec__22332 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22332,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22335 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22335["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22336 = temp__5718__auto____$1;
return (o22336["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___22343 = arguments.length;
var i__4737__auto___22344 = (0);
while(true){
if((i__4737__auto___22344 < len__4736__auto___22343)){
args__4742__auto__.push((arguments[i__4737__auto___22344]));

var G__22345 = (i__4737__auto___22344 + (1));
i__4737__auto___22344 = G__22345;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22339){
var vec__22340 = p__22339;
var ns_detector = cljs.core.nth.call(null,vec__22340,(0),null);
...
var G__22346 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22347 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22346;
remaining_tokens = G__22347;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22337){
var G__22338 = cljs.core.first.call(null,seq22337);
var seq22337__$1 = cljs.core.next.call(null,seq22337);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22338,seq22337__$1);
}));
...
var vec__22351 = cljs.core.split_with.call(null,(function (p1__22350_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22350_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22351,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22351,(1),null);
...
var vec__22357 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22357,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22357,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22360 = cljs.core.rest.call(null,remaining_tokens);
var G__22361 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22360;
name_tokens = G__22361;
continue;
} else {
...
var vec__22364 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22364,(0),null);
var arity = cljs.core.nth.call(null,vec__22364,(1),null);
var vec__22367 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22367,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22367,(1),null);
var vec__22370 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22370,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22370,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22370,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22370,(3),null);
...
var vec__22376 = result;
var munged_ns = cljs.core.nth.call(null,vec__22376,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22376,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22376,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22376,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22376,(4),null);
var arity = cljs.core.nth.call(null,vec__22376,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22380 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22380,(0),null);
var args = cljs.core.nth.call(null,vec__22380,(1),null);
var vec__22383 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22383,(0),null);
var name = cljs.core.nth.call(null,vec__22383,(1),null);
...
var G__22386 = (arity + (1));
var G__22387 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22388){
var vec__22389 = p__22388;
var arity = cljs.core.nth.call(null,vec__22389,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22389,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22392_SHARP_){
return cljs.core.get.call(null,arities,p1__22392_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22393_SHARP_){
return cljs.core.drop.call(null,(2),p1__22393_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22400 = arguments.length;
var i__4737__auto___22401 = (0);
while(true){
if((i__4737__auto___22401 < len__4736__auto___22400)){
args__4742__auto__.push((arguments[i__4737__auto___22401]));

var G__22402 = (i__4737__auto___22401 + (1));
i__4737__auto___22401 = G__22402;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22396){
var vec__22397 = p__22396;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22397,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22394){
var G__22395 = cljs.core.first.call(null,seq22394);
var seq22394__$1 = cljs.core.next.call(null,seq22394);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22395,seq22394__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22405__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22405__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22405__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22405__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22406 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22406,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22406,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22406,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22406,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22406,(4),null);
var arity = cljs.core.nth.call(null,vec__22406,(5),null);
...
var o__21495__auto__ = f;
return (o__21495__auto__["getBasis"]).call(o__21495__auto__);
});
/**
...
}catch (e22410){var _e__21502__auto__ = e22410;
...
var G__22411 = (obj[cljs.core.first.call(null,path)]);
var G__22412 = cljs.core.rest.call(null,path);
obj = G__22411;
path = G__22412;
continue;
} else {
...
var _STAR_ = (function (accum,p__22413){
var vec__22414 = p__22413;
var bit = cljs.core.nth.call(null,vec__22414,(0),null);
var protocol = cljs.core.nth.call(null,vec__22414,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22417){
var vec__22418 = p__22417;
var ns = cljs.core.nth.call(null,vec__22418,(0),null);
var name = cljs.core.nth.call(null,vec__22418,(1),null);
var selector = cljs.core.nth.call(null,vec__22418,(2),null);
...
var post_process = (function (p__22422){
var vec__22423 = p__22422;
var munged_name = cljs.core.nth.call(null,vec__22423,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22423,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22421_SHARP_){
return (obj[cljs.core.first.call(null,p1__22421_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1748975095854
