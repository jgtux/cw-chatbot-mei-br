...
return (new CustomEvent(event_name,(function (){var obj21431 = ({"detail":data});
return obj21431;
})()));
} else {
...
var f = (function (){var pred__21438 = cljs.core._EQ_;
var expr__21439 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__21438.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__21439))){
return (function (p1__21432_SHARP_){
return console.warn(p1__21432_SHARP_);
});
} else {
if(cljs.core.truth_(pred__21438.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__21439))){
return (function (p1__21433_SHARP_){
return console.debug(p1__21433_SHARP_);
});
} else {
...
return console.error(p1__21434_SHARP_);
});
} else {
return (function (p1__21435_SHARP_){
return console.log(p1__21435_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__21442){
...
var eval_fn = cljs.core.get.call(null,map__21443__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__21445_SHARP_){
return new_def.callback(p1__21445_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__21446){
var vec__21447 = p__21446;
var ky = cljs.core.nth.call(null,vec__21447,(0),null);
var v = cljs.core.nth.call(null,vec__21447,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1748975094905
