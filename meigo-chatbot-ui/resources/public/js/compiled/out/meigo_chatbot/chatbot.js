...
goog.provide('meigo_chatbot.chatbot');
goog.require('cljs.core');
goog.require('reagent.core');
goog.require('clojure.string');
if((typeof meigo_chatbot !== 'undefined') && (typeof meigo_chatbot.chatbot !== 'undefined') && (typeof meigo_chatbot.chatbot.chatbot_state !== 'undefined')){
} else {
meigo_chatbot.chatbot.chatbot_state = reagent.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"messages","messages",345434482),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"input-text","input-text",-1336297114),""], null));
}
meigo_chatbot.chatbot.bot_reply = (function meigo_chatbot$chatbot$bot_reply(user_msg){
return setTimeout((function (){
return cljs.core.swap_BANG_.call(null,meigo_chatbot.chatbot.chatbot_state,cljs.core.update,new cljs.core.Keyword(null,"messages","messages",345434482),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"from","from",1815293044),new cljs.core.Keyword(null,"bot","bot",-950896508),new cljs.core.Keyword(null,"text","text",-1790561697),["Bot: You said \"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(user_msg),"\""].join('')], null));
}),(1000));
});
meigo_chatbot.chatbot.send_message = (function meigo_chatbot$chatbot$send_message(){
var msg = clojure.string.trim.call(null,new cljs.core.Keyword(null,"input-text","input-text",-1336297114).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,meigo_chatbot.chatbot.chatbot_state)));
if((!(clojure.string.blank_QMARK_.call(null,msg)))){
cljs.core.swap_BANG_.call(null,meigo_chatbot.chatbot.chatbot_state,cljs.core.update,new cljs.core.Keyword(null,"messages","messages",345434482),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"from","from",1815293044),new cljs.core.Keyword(null,"user","user",1532431356),new cljs.core.Keyword(null,"text","text",-1790561697),msg], null));

cljs.core.swap_BANG_.call(null,meigo_chatbot.chatbot.chatbot_state,cljs.core.assoc,new cljs.core.Keyword(null,"input-text","input-text",-1336297114),"");

return meigo_chatbot.chatbot.bot_reply.call(null,msg);
} else {
return null;
}
});
meigo_chatbot.chatbot.chat_message = (function meigo_chatbot$chatbot$chat_message(p__21419){
...
cljs.core.chunk_append.call(null,b__21427,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [meigo_chatbot.chatbot.chat_message,msg], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21427),meigo_chatbot$chatbot$chatbot_panel_$_iter__21424.call(null,cljs.core.chunk_rest.call(null,s__21425__$2)));
} else {
...
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [meigo_chatbot.chatbot.chat_message,msg], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),meigo_chatbot$chatbot$chatbot_panel_$_iter__21424.call(null,cljs.core.rest.call(null,s__21425__$2)));
}
} else {
return null;
}
...
return meigo_chatbot.chatbot.send_message.call(null);
} else {
return null;
}
})], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"8px",new cljs.core.Keyword(null,"padding","padding",1660304693),"8px 12px"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),meigo_chatbot.chatbot.send_message], null),"Send"], null)], null)], null);
});
});

//# sourceMappingURL=chatbot.js.map?rel=1748865612008
