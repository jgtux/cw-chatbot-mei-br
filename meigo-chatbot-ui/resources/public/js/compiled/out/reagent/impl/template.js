...
var G__22037 = o;
goog.object.set(G__22037,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22041 = o;
goog.object.set(G__22041,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22045 = props;
var G__22045__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__22045,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22045);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22045__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__22046 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22046,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__22046;
}
})(),id_class);
...
var G__22047 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22047) {
case (0):
...
var vec__22049 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22049,(0),null);
var id = cljs.core.nth.call(null,vec__22049,(1),null);
var className = cljs.core.nth.call(null,vec__22049,(2),null);
...
var temp__5724__auto___22052 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___22052 == null)){
} else {
var key_22053 = temp__5724__auto___22052;
...
var temp__5724__auto___22054 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___22054 == null)){
} else {
var key_22055 = temp__5724__auto___22054;
(jsprops.key = key_22055);
}
...
var temp__5724__auto___22056 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___22056 == null)){
} else {
var key_22057 = temp__5724__auto___22056;
(jsprops.key = key_22057);
}
...
var temp__5724__auto___22058 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___22058 == null)){
} else {
var key_22059 = temp__5724__auto___22058;
(jsprops.key = key_22059);
}
...
var temp__5724__auto___22060 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___22060 == null)){
} else {
var key_22061 = temp__5724__auto___22060;
(jsprops.key = key_22061);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__22062_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__22062_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22063 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__22063,(0),null);
var derefed = cljs.core.nth.call(null,vec__22063,(1),null);
...
break;
default:
var G__22068 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__22069 = compiler;
v = G__22068;
compiler = G__22069;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template22073 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template22073 = (function (opts,id,fn_to_element,parse_fn,meta22074){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22073.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22075,meta22074__$1){
var self__ = this;
var _22075__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22073(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22074__$1));
}));

(reagent.impl.template.t_reagent$impl$template22073.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22075){
var self__ = this;
var _22075__$1 = this;
return self__.meta22074;
}));

(reagent.impl.template.t_reagent$impl$template22073.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22073.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22073.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template22073.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22073.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22073.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22074","meta22074",-996283288,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22073.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22073.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22073");

(reagent.impl.template.t_reagent$impl$template22073.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template22073");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22073.
 */
reagent.impl.template.__GT_t_reagent$impl$template22073 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template22073(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22074){
return (new reagent.impl.template.t_reagent$impl$template22073(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22074));
});

}

return (new reagent.impl.template.t_reagent$impl$template22073(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1748881100057
